...
const CertificationCreate = () => {
    ...
    const updateForm = (updates) => {
        setForm((prev) => {
            ...
            if (updates.title !== undefined && !form.slug) {
    ...
    return (
        <div>
            <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                    <h1 className="text-2xl font-black text-slate-900 dark:text-white font-sora">Créer une formation</h1>
                    <p className="text-slate-600 dark:text-slate-400 text-sm">Renseignez les champs pour afficher la formation sur la page Formations du site.</p>
                </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="glass-card rounded-xl p-6 sm:p-8 md:p-10 border border-slate-200 dark:border-slate-700 space-y-6 max-w-4xl">
                ...
                <div>
                    ...
                    <p className="text-xs text-slate-500 dark:text-slate-400 mb-2">Liste des objectifs pédagogiques de la formation (un par ligne).</p>
