        ...
        >
            ...
            <div className="max-w-7xl mx-auto px-6 pb-16">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-start">
                    ...
                    >
                        <div className="sticky top-28 rounded-3xl overflow-hidden border border-slate-200 dark:border-slate-600 shadow-lg shadow-slate-200/50">
                            <img
                ...
                >
                    <div className="bg-slate-900 text-white rounded-2xl shadow-xl border border-slate-700/50 overflow-hidden">
                        <div className="p-6 lg:p-8">
                            <h3 className="text-xs font-bold uppercase tracking-widest text-slate-400 mb-4">{t('contact.address')}</h3>
                            ...
                            <div className="mt-6 pt-6 border-t border-slate-700">
                                <h3 className="text-xs font-bold uppercase tracking-widest text-slate-400 mb-4">{t('contact.contacts')}</h3>
